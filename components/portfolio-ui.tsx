          ...
          <div className="lg:col-span-5 space-y-16">
            ...
            <div className="grid gap-4 md:gap-6">
              {data?.whatsapp && (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-current/10 flex items-center justify-center group-hover:bg-current transition-all duration-300">
                    <FaWhatsapp className="w-8 h-8 text-current group-hover:text-white dark:group-hover:text-black transition-colors" />
                  </div>
                  <div>
              ...
              {data?.email && (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-current/10 flex items-center justify-center group-hover:bg-current transition-all duration-300">
                    <Mail className="w-8 h-8 text-current group-hover:text-white dark:group-hover:text-black transition-colors" />
                  </div>
                  <div>
